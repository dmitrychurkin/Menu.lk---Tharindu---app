...
import { BATCH_SIZE, DATA_STORE_CURRENT_ORDERS_TOKEN, FORM_USER_TEMPLATE_DATA, WINDOW_REF, WINDOW_REF_TOKEN } from '../pages/pages.constants';
import {  AuthService, 
          NetworkService, 
          ...
          MessangingService, 
          AvailabilityService} from '../services';
...
@NgModule({
  ...
  providers: [
    ...
    { provide: FORM_USER_TEMPLATE_DATA, useFactory: (messService: MessangingService) => FORM_USER_TEMPLATE_DATA(messService), deps: [ MessangingService ],  multi: false },
